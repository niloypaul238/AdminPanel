...
const EditMasterAgency = () => {
    ...
    const filte = masterAgencyData.find((ite, index) => index === Number(id))
    //    console.log(filte);
            ...
            <div className="">
                <div className="bg-white w-full  rounded-xl shadow p-6">
                    <h2 className="text-2xl font-semibold mb-6 flex items-center gap-x-1">
                        Edit Master Agency Details<span className="text-pink-500"><img src="/Group.png" className='h-4' alt="s" /></span>
                    </h2>
...
export default EditMasterAgency;