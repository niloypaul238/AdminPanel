                    ...
                    <tbody >
                        {findObj.map((user) => (
                            ...
                            >
                                ...
                                <td onClick={() => model(user.id)} className="text-blue-600  flex items-center justify-around h-full p-3 w-full "><span className='cursor-pointer'>View</span> <HiDotsHorizontal /></td>
                            </tr>
                        ))}
                    </tbody>
                </table>
